...
public class FindGuitarTester
{
    public static void Main(string[] args)
    {
        ...
        if (guitars is { Count: > 0 }) //if (guitars != null && guitars.Count > 0)
        {
            foreach (var guitar in guitars)
            {
                ...
                Console.WriteLine($"Erin, you might like this {builder} {model} {type} guitar:");
    ...
    private static void InitializeInventory(Inventory inventory)
    {
        ...
        inventory.AddGuitar("X54321", 430.54, Builder.Martin, "Stratocastor Light", Type.Electric, Wood.IndianRosewood, Wood.Maple);
        ...
        inventory.AddGuitar("A21457", 900.55, Builder.Collings, "OakTown Goove", Type.Acoustic, Wood.BrazilianRosewood, Wood.Cedar);
